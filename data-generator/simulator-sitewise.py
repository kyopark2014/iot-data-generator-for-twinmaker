...
class Simulator:
    ...
    def build_payload(self, source):
        ...
        if t == "Double" or t == "Integer":
            ...
            #}
            msg = {
                "rVibration_Temp": new_value,
                "rVibration_Z_RMS_Velocity": new_value, 
                "rVibration_X_RMS_Velocity": new_value,
                "wRMSCurrent": new_value,
                "wCurrentLoad": new_value,
                "wEncoderVelocity": new_value, 
                "wCylinderStatus": new_value,  # true / false
                "sDateTime": int(time.time()),
